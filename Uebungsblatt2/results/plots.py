...
plt.ylabel("GFLOP/s")
plt.title("GPU-Auslastung über die Problemgröße (k=1)")
...
plt.axhline(PEAK, color="k", linestyle="--", label=f"theoretischer Peak {PEAK:.0f} GB/s")
...
plt.axhline(PEAK, color="k", linestyle=":", alpha=0.5, label="theoretischer Peak")
plt.xlabel("Occupancy (aktive / max. Warps)")
plt.ylabel("effektive Bandbreite (GB/s)")
plt.title("Latency Hiding: Bandbreite über Occupancy (coalesced)")
